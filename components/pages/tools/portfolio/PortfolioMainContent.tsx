        ...
        {mainTab === "charts" && activeTab === "portfolio" && (
          <div className="h-full overflow-auto">
            ...
            {selectedNFT ? (
                        ...
                        Object.keys(selectedNFT.token_properties).length > 0 && (
                          <div>
                            ...
                            <div className="grid grid-cols-2 gap-3">
                              {Object.entries(selectedNFT.token_properties).map(([key, value]) => (
                          ...
                          <AccordionContent>
                            <div className="space-y-2 text-sm">
                              ...
                              {selectedNFT.property_version && (
                                <div className="flex justify-between">
                                  <span className="text-muted-foreground">Property Version:</span>
                                  <span className="font-mono">{selectedNFT.property_version}</span>
                                </div>
                              )}
                            </div>
                          </AccordionContent>
                      ...
                      <div className="flex gap-2">
                        {selectedNFT.token_uri && (
                          <Button
                            variant="outline"
                            size="sm"
                            onClick={() => safeWindowOpen(selectedNFT.token_uri)}
                          >
                            View Metadata
                          </Button>
                        )}
              ...
              <div ref={assetDetailRef} className="h-full overflow-y-auto lg:overflow-hidden">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 h-auto lg:h-full pb-4 lg:pb-0">
                  ...
                  <div className="space-y-4 lg:space-y-6 lg:overflow-y-auto">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div className="p-4 bg-muted rounded-lg">
                        ...
                        <div className="text-lg font-semibold">{selectedAsset.decimals}</div>
                      </div>
                    </div>
                  ...
                  <div className="h-full">
                    <TokenChart
                      ...
                      tokenAddress={selectedAsset.token_address || selectedAsset.fa_address}
